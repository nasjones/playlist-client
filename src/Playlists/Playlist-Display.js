						...
						while (runtime < playlist.length) {
							...
							if (!chosen.includes(trackChoice)) {
								...
								for (
									let i = 0;
									i <
									response.tracks.items[trackChoice].artists
										.length;
									i++
								)
									artists.push(
								...
								let song = {
									...
									url: response.tracks.items[trackChoice]
										.external_urls.spotify,
									title: response.tracks.items[trackChoice]
										.name,
									length: response.tracks.items[trackChoice]
										.duration_ms,
									explicit:
										response.tracks.items[trackChoice]
											.explicit,
